...
class VideoBanHangPanel(QWidget):
    ...
    def _build_left_column(self, layout):
        ...
        for widget in self.gb_model.findChildren(QWidget):
        ...
        self.model_selector.setMinimumHeight(300)  # Ensure full visibility
        ...
        # Hide content initially
        for widget in self.gb_products.findChildren(QWidget):
            widget.setVisible(False)
        ...
        # Hide content initially
        for widget in self.gb_settings.findChildren(QWidget):
            widget.setVisible(False)
        ...
        form = QGridLayout()
        form.setSpacing(12)  # Increased from 8
        form.setContentsMargins(8, 8, 8, 8)
        form.setColumnMinimumWidth(0, 100)  # Label column 1
        form.setColumnMinimumWidth(1, 150)  # Input column 1
        form.setColumnMinimumWidth(2, 100)  # Label column 2
        form.setColumnMinimumWidth(3, 150)  # Input column 2
        ...
        lbl.setAlignment(Qt.AlignVCenter | Qt.AlignRight)
        form.addWidget(lbl, row, 0)
        form.addWidget(self.cb_script_model, row, 1)
        row += 1
        ...
        lbl.setAlignment(Qt.AlignVCenter | Qt.AlignRight)
        form.addWidget(lbl, row, 2)
        form.addWidget(self.cb_image_model, row - 1, 3)
        ...
        lbl.setAlignment(Qt.AlignVCenter | Qt.AlignRight)
        form.addWidget(lbl, row, 0)
        form.addWidget(self.ed_voice, row, 1)
        row += 1
        ...
        lbl.setAlignment(Qt.AlignVCenter | Qt.AlignRight)
        form.addWidget(lbl, row, 2)
        form.addWidget(self.cb_lang, row - 1, 3)
        ...
        lbl.setAlignment(Qt.AlignVCenter | Qt.AlignRight)
        form.addWidget(lbl, row, 0)
        form.addWidget(self.sp_duration, row, 1)
        row += 1
        ...
        lbl.setAlignment(Qt.AlignVCenter | Qt.AlignRight)
        form.addWidget(lbl, row, 2)
        form.addWidget(self.sp_videos, row - 1, 3)
        ...
        lbl.setAlignment(Qt.AlignVCenter | Qt.AlignRight)
        form.addWidget(lbl, row, 0)
        form.addWidget(self.cb_ratio, row, 1)
        row += 1
        ...
        lbl.setAlignment(Qt.AlignVCenter | Qt.AlignRight)
        form.addWidget(lbl, row, 2)
        form.addWidget(self.cb_social, row - 1, 3)
        ...
        settings_content_layout.addWidget(self.lb_scenes)
        ...
        # CRITICAL: Hide all section contents on initial load
    ...
    def _on_section_toggled(self, toggled_section, checked):
        """Handle section toggle - accordion behavior with content visibility"""
        if not checked:
            # User is closing section - hide its content
            for widget in toggled_section.findChildren(QWidget):
                widget.setVisible(False)
            return
        
        # User is opening section - show its content
        for widget in toggled_section.findChildren(QWidget):
        ...
        for section in sections:
            if section != toggled_section and section.isChecked():
                ...
                # Hide content of closed section
                for widget in section.findChildren(QWidget):
                    widget.setVisible(False)
